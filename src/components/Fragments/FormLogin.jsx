...
const FormLogin = () => {
    return (
        ...
        <form action="" >
        <p className="justify-center text-xl font-semibold items-center flex mb-6">Login</p>
        <InputForm label="Email" name="email" type="email" placeholder="ayy@gmail.com" />
          ...
          <Button variant="bg-[#e2fcd9]" color="text-[#3ecf4c]">Register</Button>
